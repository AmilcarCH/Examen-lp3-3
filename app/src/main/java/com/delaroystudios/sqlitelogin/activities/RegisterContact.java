...
public class RegisterContact extends AppCompatActivity implements View.OnClickListener{

    private final AppCompatActivity activity = RegisterContact.this;
    ...
    private UserDAO databaseHelper;
    private User user;
    ...
    private void initObjects(){
        ...
        databaseHelper = new UserDAO(activity);
        user = new User();
    }
